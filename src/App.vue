<script setup>
  ...
  const handleChangeDescremento = ()=> {

    const valor = cantidad.value - SETP;
...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <div class="my-5">
          <input
            type="range"
            class="w-full bg-gray-200 accent-lime-500 hove:accent-lime-600"
            :min="MIN"
            :max="MAX"
            :step="SETP"
            v-model.number="cantidad"
          />
          <p class="text-center my-10 text-5xl font-extrabold text-indigo-500">
      ...
      <p v-else class="text-center">Agrega una cantidad y elige un mes</p>
